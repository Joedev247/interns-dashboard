          ...
          <div className="grid grid-cols-5 gap-2">
            {product.images.map((image: string, index: number) => (
              <img
                ...
                className={`w-full h-20 object-cover rounded-lg cursor-pointer ${currentImageIndex === index ? 'ring-2 ring-violet-600' : ''
                  }`}
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <button
                ...
                className="flex-1 bg-violet-100 text-violet-600 py-3 rounded-lg font-semibold hover:bg-violet-200 transition-colors flex items-center justify-center space-x-2"
              >
              ...
              <button
                ...
                className="flex-1 bg-blue-600 text-white py-3 rounded-lg font-semibold hover:bg-violet-700 transition-colors"
              >
                Checkout
              </button>
            </div>
        ...
        <div className="bg-gray-50 p-4 rounded-lg mb-6">
          ...
          <div className="flex space-x-2">
            <input
              ...
              className="flex-1 p-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-violet-600"
            />
            <button
...
function setActiveItem(arg0: string) {
